...
header('location:confirmationEnvio.php');
  ...
  $body='';
    ...
    $body.=file_get_contents('https://senet.es/Email/comprarEmail.php?a='.$usuario.'&b='.$game.'&c='.$emailUsuarioActivo);
  ...
  $mail->Subject    = 'Solicitud de compra de un juego de mesa';
  $mail->MsgHTML($body);
